...
/**
 * Entity mapped to table "DANG_KY_MON_HOC_MODEL".
 */
public class DangKyMonHocModel {

    private String MonHocID;
    private String SinhVienID;
    private java.util.Date Date;

    public DangKyMonHocModel() {
    }

    public DangKyMonHocModel(String MonHocID, String SinhVienID, java.util.Date Date) {
